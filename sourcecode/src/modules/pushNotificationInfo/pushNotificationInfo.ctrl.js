...
exports.pushNotificationInfo = function (req, res) {
  /**  ========================== [START VALIABLE] ========================== */
  ...
  /**  ========================== [START LOG] ========================== */
  appLog.info('==========> pushNotificationInfo proccessing <==========')
  ...
  try {
    ...
    // customerId: '8812345678'
    // customerId: '8712345678@playbox.co.th'
    }
    res.req = req
