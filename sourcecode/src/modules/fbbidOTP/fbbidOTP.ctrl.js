...
exports.fbbidOTP = function (req, res) {
  /**  ========================== [START VALIABLE] ========================== */
  ...
  /**  ========================== [START LOG] ========================== */
  appLog.info('==========> fbbidOTP proccessing <==========')
  ...
  const opt = {
    headers: {
      'X-Session-Id': req.query.sid,
      'X-Rtid': req.query.rtid,
      'X-Tid': req.query.tid
    }
  }
  ...
  try {
    ...
    const ret = {
      ...
      contact_number : "099xxx4567",
      reference_id : "QnlKSS9RpyxsE9JJWeqdJQ=="
    }
