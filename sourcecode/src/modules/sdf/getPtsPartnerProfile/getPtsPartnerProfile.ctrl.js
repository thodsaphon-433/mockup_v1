...
exports.getPtsPartnerProfile = function (req, res) {
  /**  ========================== [START VALIABLE] ========================== */
  ...
  /**  ========================== [START LOG] ========================== */
  appLog.info('==========> getPtsPartnerProfile proccessing <==========')
      ...
      ptsPartnerProfile: [
        {
          ...
          ds: "Profile",
          objectClass: "ptsPartnerProfile",
          email: "$email",
          partnerId: "$partnerId",
          ptsPartnerFirstName: "$ptsPartnerFirstName",
          ptsPartnerLastName: "$ptsPartnerLastName",
          ptsPartnerPassword: "$ptsPartnerPassword",
          ptsPartnerISDN: "$ptsPartnerISDN",
          ptsPartnerState: "active",
          ptsPartnerRole: "$ptsPartnerRole",
          ptsIdResponsePolicy: "$ptsIdResponsePolicy",
          ptsPrime: "$ptsPrime",
          ptsPrimitiveRoot: "$ptsPrimitiveRoot",
