...
exports.obtainAuthorityList = function (req, res) {
  /**  ========================== [START VALIABLE] ========================== */
  ...
  /**  ========================== [START LOG] ========================== */
  appLog.info('==========> obtainAuthorityList proccessing <==========')
  ...
  try {
    ...
    const ret = {
      ...
      accessToken: 'jhgujyfytdthjdkhgfl',
      expireIn: '50008',
      ptsListOfAPI: [
        'AIS Exculusive|C:password,R:no,U:password,D:0,L:token|no',
        'Push Notification|C:password,R:no,U:password,D:0,L:token|yes'
      ],
      idType: 'awn',
      idValue: 'E.164',
      operatorId: '66912345678',
    ...
    res.set(
      {
        ...
        'X-Partner-Specific-Private-Id': 'zvwY6hEbL5BREEp5bgi8vAgQvtgp8NaJ',
        'X-Access-Token': 'MU' + genUtil.genXsession(),
        'X-Uid': 'MU' + genUtil.genXsession()
      }
    )
